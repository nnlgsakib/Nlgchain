...
import (
	...
	marketmodule "nlgcoin/x/market"
	marketmodulekeeper "nlgcoin/x/market/keeper"
	marketmoduletypes "nlgcoin/x/market/types"
	mftmodule "nlgcoin/x/mft"
	mftmodulekeeper "nlgcoin/x/mft/keeper"
	mftmoduletypes "nlgcoin/x/mft/types"
	multisigmodule "nlgcoin/x/multisig"
	multisigmodulekeeper "nlgcoin/x/multisig/keeper"
	multisigmoduletypes "nlgcoin/x/multisig/types"
	nameservicemodule "nlgcoin/x/nameservice"
	nameservicemodulekeeper "nlgcoin/x/nameservice/keeper"
	nameservicemoduletypes "nlgcoin/x/nameservice/types"
	nftmodule "nlgcoin/x/nft"
	nftmodulekeeper "nlgcoin/x/nft/keeper"
	nftmoduletypes "nlgcoin/x/nft/types"
	nlgcoinmodule "nlgcoin/x/nlgcoin"
	nlgcoinmodulekeeper "nlgcoin/x/nlgcoin/keeper"
	nlgcoinmoduletypes "nlgcoin/x/nlgcoin/types"
	oraclemodule "nlgcoin/x/oracle"
	oraclemodulekeeper "nlgcoin/x/oracle/keeper"
	oraclemoduletypes "nlgcoin/x/oracle/types"
	tokenmodule "nlgcoin/x/token"
	tokenmodulekeeper "nlgcoin/x/token/keeper"
	tokenmoduletypes "nlgcoin/x/token/types"
	treasurymodule "nlgcoin/x/treasury"
	treasurymodulekeeper "nlgcoin/x/treasury/keeper"
	treasurymoduletypes "nlgcoin/x/treasury/types"
	wasmmodule "nlgcoin/x/wasm"
	wasmmodulekeeper "nlgcoin/x/wasm/keeper"
	wasmmoduletypes "nlgcoin/x/wasm/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "nlgcoin/app/params"
	"nlgcoin/docs"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		nlgcoinmodule.AppModuleBasic{},
		wasmmodule.AppModuleBasic{},
		mftmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	NlgcoinKeeper nlgcoinmodulekeeper.Keeper

	WasmKeeper wasmmodulekeeper.Keeper

	MftKeeper mftmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		nlgcoinmoduletypes.StoreKey,
		wasmmoduletypes.StoreKey,
		mftmoduletypes.StoreKey,
	...
	*/
	...
	app.NlgcoinKeeper = *nlgcoinmodulekeeper.NewKeeper(
		appCodec,
		keys[nlgcoinmoduletypes.StoreKey],
		keys[nlgcoinmoduletypes.MemStoreKey],
		app.GetSubspace(nlgcoinmoduletypes.ModuleName),
	)
	nlgcoinModule := nlgcoinmodule.NewAppModule(appCodec, app.NlgcoinKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.MftKeeper = *mftmodulekeeper.NewKeeper(
		appCodec,
		keys[mftmoduletypes.StoreKey],
		keys[mftmoduletypes.MemStoreKey],
		app.GetSubspace(mftmoduletypes.ModuleName),
	)
	mftModule := mftmodule.NewAppModule(appCodec, app.MftKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		nlgcoinmoduletypes.ModuleName,
		wasmmoduletypes.ModuleName,
		mftmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(nlgcoinmoduletypes.ModuleName)
	paramsKeeper.Subspace(wasmmoduletypes.ModuleName)
	paramsKeeper.Subspace(mftmoduletypes.ModuleName)
